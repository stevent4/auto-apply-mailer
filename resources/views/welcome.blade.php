...
<head>
    ...
    {{-- =========================================================
        FONT
        Lora untuk judul (kesan surat), Inter untuk UI — konsisten
        dengan halaman Template, Buat Lamaran, Berkas, dan Feedback.
    ========================================================== --}}
    ...
    <style>
        ...
        * {
        ...
        .hero {
            padding: 30px 0 30px;
            background:
                radial-gradient(circle at top right, var(--accent-soft) 0, transparent 36%),
