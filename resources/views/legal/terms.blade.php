<x-guest-layout title="Terms — Auto Apply Mailer">
    <div class="space-y-8">
        ...
        <div class="space-y-8 text-sm leading-7 text-slate-600">
            ...
            <section>
                <h2 class="text-base font-semibold text-slate-900">
                    7. Kepatuhan Google dan Layanan Pihak Ketiga
                </h2>
            ...
            <section>
                <h2 class="text-base font-semibold text-slate-900">
                    8. File, Dokumen, dan Konten Pengguna
                </h2>
            ...
            <section>
                <h2 class="text-base font-semibold text-slate-900">
                    11. Penghentian atau Pembatasan Akun
                </h2>
            ...
            <section>
                <h2 class="text-base font-semibold text-slate-900">
                    12. Perubahan Fitur dan Ketentuan
                </h2>
            ...
            <section>
                <h2 class="text-base font-semibold text-slate-900">
                    14. Hubungan dengan Layanan Pihak Ketiga
                </h2>
